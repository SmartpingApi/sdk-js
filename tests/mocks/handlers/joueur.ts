 ...
 * - Sinon : 200 OK
 */
export default http.get(endpoint(ApiEndpoints.XML_JOUEUR), ({ request }) => {
	...
	const license = url.searchParams.get('licence');
	...
	return HttpResponse.xml(getMockResponse('joueur', {}), { status: 200, headers: successHeaders });
});
